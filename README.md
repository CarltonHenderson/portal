...
This is a rough draft proof of concept of a python program which allows two
Raspberry Pi systems, each equipped with a webcam and HDMI screen, to work like
a portal from the Portal video game.
...
quality (2 on a scale of 0-100), encoded as base64, and put into a json body
suitable for the Notecard JSON API.
